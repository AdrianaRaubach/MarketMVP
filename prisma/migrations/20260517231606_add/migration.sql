...
INSERT INTO "new_address" ("city", "createdAt", "id", "person_id", "state", "street", "updatedAt", "zipCode") SELECT "city", "createdAt", "id", "person_id", "state", "street", "updatedAt", "zipCode" FROM "address";
DROP TABLE "address";
